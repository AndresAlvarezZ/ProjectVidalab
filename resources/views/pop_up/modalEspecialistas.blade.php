                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <textarea required  name="especialidadesDelEspecialista1" class="form-control" placeholder="Ingrese especialidades o experiencia del especialista" id="especialidadesDelEspecialista1" rows="6">{{old('especialidadesDelEspecialista1')}}</textarea>
