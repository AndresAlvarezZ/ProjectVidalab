                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input required type="text" class="form-control" placeholder="Ingrese el primer nombre del especialista" name="nombreDelEspecialista1" id="nombreDelEspecialista1"/> <br>
                                ...
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" placeholder="Ingrese el segundo nombre del especialista" name="segundoNombreDelEspecialista1" id="segundoNombreDelEspecialista1"/> <br>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input required type="text" class="form-control" placeholder="Ingrese el primer apellido del especialista" name="primerApellidoDelEspecialista1" id="primerApellidoDelEspecialista1"/> <br>
                                ...
                                <div class="col">
                                    ...
                                    <input required type="text" class="form-control" placeholder="Ingrese el segundo apellido del especialista" name="segundoApellidoDelEspecialista1" id="segundoApellidoDelEspecialista1"/> <br>
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input required type="text" class="form-control" placeholder="Ingrese un correo electrónictrónico para contacto con los clientes" name="correoDelEspecialista1" id="correoDelEspecialista1"/> <br>
                                ...
                                <div class="col">
                                    ...
                                    <input required type="text" class="form-control" placeholder="Ingrese la sede VIDAlab en la que desempeña el especialista" name="sedeDelEspecialista1" id="sedeDelEspecialista1"/> <br>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row">
                                <div class="col">
                                    ...
                                    <input required type="text" class="form-control" placeholder="Ingrese un correo electrónictrónico para contacto con los clientes" name="correoDelEspecialista3" id="correoDelEspecialista3"/> <br>
                                ...
                                <div class="col">
                                    ...
                                    <input required type="text" class="form-control" placeholder="Ingrese la sede VIDAlab en la que desempeña el especialista" name="sedeDelEspecialista3" id="sedeDelEspecialista3"/> <br>
