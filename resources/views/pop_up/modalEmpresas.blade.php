                    ...
                    <form id="importarForm" action="/importar/registros/empresas" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            ...
                            <div class="alert alert-warning">
                                <b>Pasos: </b><br>
                                <b>1) Ir a:</b> <a href="https://docs.google.com/spreadsheets/d/1riA6C_4jqe_-MALblGQDO5OMPr6BDdL8CYgyJhO6J9g/edit?usp=sharing" target="_blank"> Plantilla Editable de Excel</a> <span class="icon-folder-download"> </span><br>
                                <b>2) Agregar o copiar:</b> los datos según los encabezados de cada columna en la plantilla.<br>
                                <b>3) Lo que no debe hacer:</b> agregar u ocultar columnas, no agregue más hojas a la plantilla, no deje campos vacíos y no ingresar correos electrónicos en letra mayúscula.<br>
                                <b>4) Verificar:</b> aplicar formato general a las columnas.<br>
