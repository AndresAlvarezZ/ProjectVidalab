      ...
      <div class="row no-gutters">
        ...
        <div class="col-sm">
          <div class="card notificaciones" style="max-width: 50rem;">
            <div class="card-header"><center><h4><b>CORREOS PERSONALIZADOS ENVIADOS A EMPRESAS</b></h4></center></div>
              <div class="card-body">
                ...
                <center>
                  <ul class="list-group">
                    <table id="registrosEmpresasP" class="table table-striped" style="width:100%">
                      <thead>
                        <tr>
