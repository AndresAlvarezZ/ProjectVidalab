        ...
        <div class="col-sm">
                      ...
                      <tbody>
                        ...
                        @foreach($notificaciones as $notificacion)
                              <tr>
                                  ...
                                  <td><center><a href="/mostrarNotificaciones/{{$notificacion->id}}" class="btn btn-info btnEditar" data-toggle="tooltip" data-placement="right" title="Click para ver el correo completo"><span class="icon-eye"></span></span>Ver</a></center></td>
                              </tr>
                              <?php $contador++; ?>
                        @endforeach
                      </tbody>
          ...
          <div class="col-lg">
            <div class="card" style="max-width: 50rem;">
              ...
              <div class="card-body">
                <form id="notificacionEmpresasM" action="/envioNotificacionMasivaEmpresarial" method="post" enctype="multipart/form-data" target="_self">
                  @csrf
