                            ...
                            <tbody>
                                @foreach($administradores as $administrador)
                                    ...
                                    <tr>
                                        ...
                                        <td><center>
                                            <a href="#" class="btn btn-success btnActivar" data-toggle="tooltip" data-placement="right" title="Click para conceder a este administrador el acceso al sistema"><span class="icon-checkmark"></span>Conceder Acceso</a>
                                        </center></td>
                                    </tr>
                                    @endif
                                @endforeach   
