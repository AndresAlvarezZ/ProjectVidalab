...
@section('content')
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="title">
				<h2 class="tituloDeRegistro"><span>R</span>egistro de <span>A</span>dministradores <span>A</span>ctivos</h2>
			</div>
            <div class="card-body">
                    ...
                    <tbody>
                        ...
                        @if($administrador->estadoDelUsuarioAdministrador == 1)
                            <tr>
                                ...
                                <td><center>
                                    <a href="#" class="btn btn-danger btnInactivar" data-toggle="tooltip" data-placement="right" title="Click para denegar a este administrador el acceso al sistema"><span class="icon-user"> </span><span class="icon-cross"></span></a>
                                </center></td>
                            </tr>
                            @endif
                        @endforeach   
