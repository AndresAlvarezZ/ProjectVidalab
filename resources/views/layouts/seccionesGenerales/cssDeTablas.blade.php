...
<!--DATATABLES BUSQUEDAS, BOTONES, COLUMNAS FIJAS-->
...
<!--ICONOS-->
    <script src="https://kit.fontawesome.com/692c64c2d5.js" crossorigin="anonymous"></script>   
...
<!--ESTILO GENERAL DE TABLA-->
    <link href="{{ asset('css/elementosDeTabla.css') }}?v=<?php echo(rand()); ?>" rel="stylesheet">
<!---->

<!--ESTILO MENU DEL ADMINISTRADOR-->
