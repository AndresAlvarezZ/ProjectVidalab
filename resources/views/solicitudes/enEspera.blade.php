                        ...
                        <table id="registros" class="table table-hover">
                            ...
                            <tbody>
                                @foreach($enEspera as $solicitud)
                                    <tr>
                                        <td>{{$solicitud->idFactura}}</center></td>
                                        <td>{{$solicitud->nombreDelCiente}}</center></td>
                                        <td>{{$solicitud->domicilioDelCiente}}</center></td>
                                        <td>{{$solicitud->telefonoDelCliente}}</center></td>
                                        <td>{{$solicitud->analisisSolicitados}}</center></td>
                                        <td>{{$solicitud->costoDelServicio}}</center></td>
                                        <td><center><a href="/solicitudes/cambioDeEstado/{{$solicitud->idDeSolicitud}}" class="btn btn-primary">Procesar Solicitud</a> </center></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
