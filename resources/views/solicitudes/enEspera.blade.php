...
@section('content')
    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="title">
				<h2 class="tituloDeRegistro"><span>R</span>egistro de <span>S</span>olicitudes <span>E</span>n <span>E</span>spera</h2>
			</div>
            <div class="card-body">
                    ...
                    <tbody>
                        @foreach($enEspera as $solicitud)
                            <tr>
                                ...
                                <td><center><a href="#" class="btn btn-primary btnEnEspera" data-toggle="tooltip" data-placement="right" title="Click para actualizar el estado de esta solicitud"><span class="icon-loop2"></span></a></center></td>
                            </tr>
                        @endforeach
                    </tbody>
                </table>
