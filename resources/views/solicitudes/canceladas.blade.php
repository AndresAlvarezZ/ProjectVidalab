                            ...
                            <tbody>
                                @foreach($canceladas as $solicitud)
                                    <tr>
                                        ...
                                        <td><center><a href="#" class="btn btn-primary btnEnCancelada" data-toggle="tooltip" data-placement="right" title="Click para actualizar el estado de esta solicitud"><span class="icon-loop2"></span>Procesar Solicitud</a></center></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
