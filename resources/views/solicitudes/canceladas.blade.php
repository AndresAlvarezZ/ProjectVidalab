...
@section('content')
    ...
    <body>
        <div class="container-fluid">
            <div class="card-header"><h4><b><center>REGISTRO DE SOLICITUDES EN ESTADO: CANCELADAS</center></b></h4></div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach($canceladas as $solicitud)
                                    <tr>
                                        ...
                                        <td><center><a href="#" class="btn btn-primary btnEnCancelada" data-toggle="tooltip" data-placement="right" title="Click para actualizar el estado de esta solicitud">Procesar Solicitud</a></center></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
