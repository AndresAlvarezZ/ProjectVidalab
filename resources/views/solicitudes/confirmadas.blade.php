                        ...
                        <tbody>
                            @foreach($confirmadas as $solicitud)
                                <tr>
                                    ...
                                    <td><center><a href="#" class="btn btn-primary btnEnConfirmada" data-toggle="tooltip" data-placement="right" title="Click para actualizar el estado de esta solicitud"><span class="icon-loop2"></span></a></center></td>
                                </tr>
                            @endforeach
                        </tbody>
                    </table>
