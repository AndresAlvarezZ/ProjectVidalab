...
@section('content')
    ...
    <body>
        <div class="container-fluid">
            <div class="card-header titulo"><h4><b><center>REGISTRO DE SOLICITUDES EN ESTADO: CONFIRMADAS</center></b></h4></div>
                <div class="card-body">
                            ...
                            <tbody>
                                @foreach($confirmadas as $solicitud)
                                    <tr>
                                        ...
                                        <td><center><a href="#" class="btn btn-primary btnEnConfirmada" data-toggle="tooltip" data-placement="right" title="Click para actualizar el estado de esta solicitud"><span class="icon-loop2"></span>Procesar Solicitud</a></center></td>
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
