                  ...
                  @endif
                    <div class="row">
                        <div class="col-lg-12 margin-tb">
                            <button type="button" class="btn btn-primary btnAgregar" data-toggle="modal" data-target="#agregarArchivo" data-toggle="tooltip" data-placement="right" title="Click para agregar datos de nuevo contenido"><span class="icon-camera"> </span>Agregar Contenido</button>
                        </div>
                        <br>
                        <br>
                        <div class="col-lg-12 margin-tb">
                            <a href="/verContenido" type="button" class="btn btn-primary btnAgregar"  data-placement="right" title="Ver contenido completo"><span class="icon-eye"> </span>Ver Contenido</a>
                        </div>
                    </div>
                    <br>
