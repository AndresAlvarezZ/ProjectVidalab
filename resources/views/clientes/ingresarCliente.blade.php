                                ...
                                <div class="card-body">
                                    <form  method="POST" action="/afiliarme">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="form-group col-md-6">
                                                <label for="nombreDelCliente" class="col-md-4 col-form-label text-md-center">{{ __('Nombre') }}</label>
                                                <input id="nombreDelCliente" type="text" placeholder="Ingrese su nombre" class="form-control @error('nombreDelCliente') is-invalid @enderror" name="nombreDelCliente" value="{{ old('nombreDelCliente') }}" required autocomplete="nombreDelCliente" autofocus>
