$(document).ready(function() 
{
    ...
    $('#registrosClientesP thead tr').clone(true).appendTo( '#registrosClientesP thead' );
    $('#registrosClientesP thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#registrosClientesP').DataTable(
    {
