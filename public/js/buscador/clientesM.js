$(document).ready(function() 
{
    ...
    $('#registrosClientesM thead tr').clone(true).appendTo( '#registrosClientesM thead' );
    $('#registrosClientesM thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#registrosClientesM').DataTable(
    {
