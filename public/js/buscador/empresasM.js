$(document).ready(function() 
{
    ...
    $('#registrosEmpresasM thead tr').clone(true).appendTo( '#registrosEmpresasM thead' );
    $('#registrosEmpresasM thead tr:eq(1) th').each( function (i) {
        var title = $(this).text();
    ...
    var table = $('#registrosEmpresasM').DataTable(
    {
